...
// Allows user to view & customise bindings stored in Zustand settings.
  ...
  return (
    <div className="space-y-4">
      ...
      <button
        ...
        onClick={handleSave}
        className={`rounded px-3 py-1 text-sm ${dirty && duplicates.length === 0 ? 'bg-blue-600 text-white' : 'bg-neutral-700 text-neutral-400 cursor-not-allowed'}`}
      >
        Save
      </button>
      <button
